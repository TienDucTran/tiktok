...
function DownloadApp() {
    ...
    return (
        <div className={cx('wrapper', { 'show': visible })}>
            ...
            <Button className={cx({ 'active': active })} rounded onClick={handleClick}>
                Get app
            </Button>
            <div className={cx('download-container')}>
                <div className={cx('download-close-icon')} onClick={handleClick}>
                    <BigCloseIcon />
                </div>
                <div className={cx('download-wrapper-icon')}>
                    <Button className={cx('download-item-icon')} icon={< DestopIcon />}>Get TikTok for desktop</Button>
                    <div className={cx('download-split-center')}></div>
                    <Button className={cx('download-item-icon')} icon={<SmartPhoneIcon />}>Get TikTok App</Button>
                </div>
